        ...
        <section className="relative overflow-hidden text-gray-600 body-font z-0 pb-32 sm:pb-52">
            ...
            <div className="pb-8  max-w-4xl mx-auto fsac4 px-4 ">
                ...
                <CategoryCard
                    linkRef={"koncerti"}
                    title={"КОНЦЕРТИ"}
                    description={"Нашите сцени винаги се различават с наш собствен стил - наличие на мултимедийни екрани, украси, декорации и разнообразни ефекти."}
                />

                <CategoryCard
                    linkRef={"kino"}
                    title={"ПЪТУВАЩО КИНО"}
                    description={"Прожекции на открито \n на най-новите тематично подбрани филми."}
                />
            ...
            <div className="max-w-lg mx-auto px-4">
                <CategoryCard
                    linkRef={"fusion-show"}
                    title={"FUSION SHOW"}
                    description={"Впечатляващо визуално шоу, \n комбиниращо мултимедийни картини и светлинни ефекти."}
                />
            </div>
